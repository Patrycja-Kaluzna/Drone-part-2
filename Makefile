...
./dron_etap_1: obj/main.o obj/lacze_do_gnuplota.o obj/powierzchnia.o obj/wieloscian.o obj/prostopadloscian.o obj/dron.o obj/scena.o
	g++ -Wall -pedantic -std=c++11 -o ./dron_etap_1 obj/main.o obj/lacze_do_gnuplota.o obj/powierzchnia.o\
			obj/wieloscian.o obj/prostopadloscian.o obj/dron.o obj/scena.o
